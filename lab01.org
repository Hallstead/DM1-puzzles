...
/You measure the bombs in threes. First weigh the first two group of threes to determine where the bomb is located. If they are equal measure two/
/of the bombs in the group that wasn't weighed. Otherwise, weigh two of the bombs that are in the heavier group. If they are equal it is the bomb/
/that wasn't weighed. Otherwise, it is the heavier bomb./ 
* TODO The BEAST
  :LOGBOOK:
